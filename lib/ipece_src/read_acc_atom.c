...
void read_acc_atom(ATOMS atoms, char *acc_fname) {
    ...
    . N   ARG A0017   49.249
    v2.5.1:
    [catalys@sibyl ipc]> head acc.atm
    ATOM    N   ARG A0017   49.249
    ATOM    CA  ARG A0017    3.381
    ATOM    C   ARG A0017    2.254
    ATOM    O   ARG A0017   22.200
    ATOM    CB  ARG A0017    5.636
    */
    ...
    while (fgets(line, TXT_LEN_MAX, acc_fp)) {
        ka_start = ka;
        while ( strncmp(line+7, atoms.array[ka].pdb_line+17, 10) || strncmp(line+1, atoms.array[ka].pdb_line+13, 4) ) { 
              /* Keep within the loop if not same residue name or not same atom name. */
            ka++;
