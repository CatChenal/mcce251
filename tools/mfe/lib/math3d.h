...
namespace Math3D {
    ...
    class Vector4 {
        ...
        inline Vector4& Normalize3 (void);
        ...
        inline Vector4_int to_grid_index(Vector4 boundary, Vector4 grid_space);
    ...
    /*
    inline Vector4& Vector4::Normalize3(void) {
        scalar_t length = Length3(const this);
        this /= Length3(const this);
        return *this;
    };
    */
